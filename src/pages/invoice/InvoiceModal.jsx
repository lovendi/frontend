              ...
              <div className="p-4" id="print">
                ...
                <div className="mt-6">
                  <div className="mb-4 grid grid-cols-2">
                    <span className="font-bold">Nomer Invoice</span>
                      ...
                      {items.map((item) => (
                        <tr key={item.id}>
                          ...
                          <td className="min-w-[80px] text-right">
                            Rp.{Number(item.price).toFixed()}
                          </td>
                          <td className="min-w-[90px] text-right">
                            Rp.{Number(item.price * item.qty).toFixed()}
                          </td>
                        </tr>
                      ))}
                    </tbody>
                  ...
                  <div className="mt-4 flex flex-col items-end space-y-2">
                    <div className="flex w-full justify-between border-t border-black/10 pt-2">
                      ...
                      <span>Rp.{invoiceInfo.subtotal.toFixed()}</span>
                    </div>
                    <div className="flex w-full justify-between">
                      <span className="font-bold">Discount:</span>
                      <span>Rp.{invoiceInfo.discountRate.toFixed()}</span>
                    </div>
                    <div className="flex w-full justify-between">
                      <span className="font-bold">Tax:</span>
                      <span>Rp.{invoiceInfo.taxRate.toFixed()}</span>
                    </div>
                    <div className="flex w-full justify-between">
                      <span className="font-bold">Kembalian:</span>
                      <span>Rp.{invoiceInfo.kembalian.toFixed()}</span>
                    </div>
