...
const AddProduct = () => {
  ...
  useEffect(() => {
    getCategorys(), getUnits(), getSuppliers();
  }, []);
              ...
              <div className="field w-full px-3 md:w-1/3">
                ...
                <div className="control">
                  <input
                    ...
                    disabled className="mb-5 appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
